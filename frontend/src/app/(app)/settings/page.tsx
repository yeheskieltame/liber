...
export default function SettingsPage() {
  ...
  useEffect(() => {
    getActiveWallet().then((wallet) => {
      ...
      setIsExternalWallet(wallet.mode === "external");
          ...
          <>
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-ink/60">
                This wallet is connected through an external wallet app. Liber never holds its secret key - back up
